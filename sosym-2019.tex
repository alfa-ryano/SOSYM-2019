...
\begin{table}[ht]
  ...
  \begin{scriptsize}
    \begin{sffamily}
      \begin{tabular}{|m{0.31\linewidth}|m{0.27\linewidth}|m{0.27\linewidth}|}
        \hline
