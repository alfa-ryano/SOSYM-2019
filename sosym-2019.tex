...
If we apply an operation $o_{l}$ to an element $e_{o}$ then it changes the element to a new state $e_{l}$, where $+$ is the operator of applying an operation.
